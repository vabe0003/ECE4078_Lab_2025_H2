...
class Operate:
    def __init__(self, args):
        ...
        self.true_map = EKF.load_true_map("TrueMap.txt")# change1
    ...
    def draw(self, canvas):
        ...
        #ekf_view = self.ekf.draw_slam_state_with_truth(self.true_map,
            #res=(320, 480+v_pad), not_pause=self.ekf_on) change
        ekf_view = self.ekf.draw_slam_state_with_truth(self.true_map,
            res=(320, 480+v_pad), not_pause=self.ekf_on)
